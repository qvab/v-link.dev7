...
<div class="container">
  <div class="row">
    <div class="col-xs-12 col-sm-4">
      <img src="<?=TEMPLATE_T?>assets/img/avatar.jpg" alt="">
    </div>

    <div class="col-xs-12 col-sm-8 header-detail">
      <div class="hgroup">
        <h1>Михаил Мишанин</h1>
        <h3>Веб-разработчик</h3>
      </div>
      <hr>
      <p class="lead">Душа моя озарена неземной радостью, как эти чудесные весенние утра, которыми я наслаждаюсь от
        всего сердца. Я совсем один и блаженствую в здешнем краю, словно созданном для таких, как я. Я так счастлив, мой
        друг, так упоен ощущением покоя, что искусство мое страдает от этого. Ни одного штриха не мог бы я сделать, а
        никогда не был таким большим художником, как в эти минуты. Когда от милой моей долины поднимается пар и
        полдневное солнце стоит над непроницаемой чащей темного леса и лишь редкий луч проскальзывает в его святая
        святых, г</p>

      <ul class="details cols-2">
        <li>
          <i class="fa fa-map-marker"></i>
          <span>Росиия, Самара</span>
        </li>

        <li>
          <i class="fa fa-globe"></i>
          <a href="#">mishaninlab.ru</a>
        </li>

        <li>
          <i class="fa fa-money"></i>
          <span>100 000 / мес.</span>
        </li>
        ...
        <li>
          ...
          <span>+7 927 557-56-98</span>
        </li>

        <li>
          <i class="fa fa-envelope"></i>
          <a href="#">mishanin@mywebsite.me</a>
        </li>
      </ul>
  ...
  <div class="button-group">
    ...
    <div class="action-buttons">
      <a class="btn btn-success" href="#">Получить контакт</a>
    </div>
  </div>
</div>
</header>
