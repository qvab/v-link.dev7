...
if (!empty($_GET["search"])) {
  ...
  if (!empty($_GET["search"]["key"])) {
    ...
    } elseif ($_GET["search"]["typekey"] == "resume") {
...
?><?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"FILTER_PROPERTY_CODE" => array("","EMAIL","ID_LOCATION","SCHEDULE","HAPPY_DAY","PAYMENT","CATEGORIES","KEY_WORDS","PHONE","EDUCATIONS","GENDER","PREV_WORKS","ID_USER","TYPE_OF_EMP",""),
